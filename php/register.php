    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link button white-color btn btn-outline-primary active" href="../php/register.php">Sign Up</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link button white-color btn btn-outline-primary" href="../php/login.php">Login</a>
                </li>
            </ul>
        </div>
    </div>
