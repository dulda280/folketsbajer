...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<article class='card'>";
            echo "<h3 class='card__title center'>" . $row['username'] . "</h3>";
            echo "<br>";
            ...
            echo "<div class='flip-card'>";
                echo "<div class='flip-card-inner'>";
                    echo "<div class='flip-card-front hvr-shutter-in-vertical'>";
                        echo "<h1 id='sum-number-index'>" . $row['id'] .  "<img src='../pics/star-filled.png' style='margin-bottom: .3em;margin-left: .2em' class='rating-star' alt=''></h1>";
                    echo "</div>";
